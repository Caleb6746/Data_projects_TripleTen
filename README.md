...
| :-----------: | ----------- |----------- |
| 1 | NYC Airbnb Vacation Rental Market | Utilized advanced spreadsheets to analyze which neighborhoods and property sizes where the most attractive for vacation rentals and how much those listings generated. |
| 2 | VentureInsight investment report | Wrote queries on SQL to identify industry and finance influencers, analyze cash acquistion, geographic investment, and whether education correlates with success in that field and more. |
